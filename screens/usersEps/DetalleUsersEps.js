...
export default function DetalleUserEps() {
    ...
    const handleUserEps = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                Alert.alert("Error", result.message || "No se pudierón cargas los userEps");
            }
        } catch (error) {
            Alert.alert("Error", "No se pudierón cargas los userEps");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleCrear = () => {
        navigation.navigate('CreateUserEps');
    };
    ...
    const handleEditar = (UserEps) => {
        navigation.navigate("EditUserEps", { UserEps });
